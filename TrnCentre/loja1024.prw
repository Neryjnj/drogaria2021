	...
	While lBuscaPre
		...
		If lRetorno
			...
			If oServicos:Count() > 0
				...
				If nIndCont > 0
					...
					If oServicoN != Nil
						cNSU := oServicoN:cNSU
					Else
						MsgAlert(STR0011,"TRNCentre") //"NSU da consulta inicial nใo retornado no servicoN"
						lRetorno := .F.	
						lBuscaPre := .F.
					EndIf
				Else
			...
			Else
				...
				MsgAlert(STR0010,"TRNCentre") //"Lista de produtos TRN-CENTRE nใo retornada no servicoX"			
				lRetorno := .F.
				lBuscaPre := .F.
			EndIf
		Else
