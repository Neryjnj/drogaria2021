...
//No TotvsPDV o menu serแ incluido normalmente pois o menu ้ diferente do Front porem devo tratar 
//se tem informa็ใo da ANVISA para nใo mostrar a tela vazia de LK9
If lTotvsPDV
	lContinua := T_DroLenANVISA() > 0

	If !lContinua
		MsgAlert("Nใo hแ dados de Medicamentos Controlados")
		LjGrvLog("DroVSNGPC", "Nใo hแ dados de Medicamentos Controlados")
	EndIf
EndIf
...
If lContinua
	...
	//Caso nใo veio da tela de aprova็ใo de medicamentos. Se veio da tela da Venda Assistida, preciso recuperar os dados digitados ao incluir um item novo.
	...
	If lTotvsPDV //Deve desativar os atalhos para que nใo d๊ problema nas teclas
		STIBtnDeActivate()
	EndIf
	...
	If lTotvsPDV //Deve ativar os atalhos para que nใo d๊ problema nas teclas
		STIBtnActivate()
	EndIf
EndIf
